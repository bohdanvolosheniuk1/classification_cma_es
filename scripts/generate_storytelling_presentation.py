...
SLIDES = [
    ...
    # ---- Слайд 2 — числа, що чіпляють ----
    {
        ...
        "numbers": [
            ("235K", "URL-адрес", "оброблено", COLOR_ACCENT_2),
            ("12", "моделей", "порівняно", COLOR_ACCENT_1),
            ("34", "тести", "усі проходять", COLOR_ACCENT_3),
        ],
        "tagline": "Усі цифри — з реальних прогонів програми",
        "speech": (
            "Спочатку про масштаб. Програма обробила 235 тисяч URL-адрес "
            "у задачі phishing detection. Реалізовано 12 моделей "
            "класифікації — від класичної логістичної регресії до "
            "нейронних мереж, навчених без використання градієнтів. "
            "Покрито 34 автоматизованими тестами на pytest. Усі цифри "
            "— з реальних прогонів, не симуляція."
        ),
    },
    ...
    # ---- Слайд 10 — Результати, podium ----
    {
        ...
        "speech": (
            ...
            "На незбалансованій задачі Loan Approval — tuned_mlp. "
            "Найважливіший висновок: моделі з префіксом tuned, де CMA-ES "
            "підбирає гіперпараметри, стабільно перевершують свої "
            "базові варіанти на всіх трьох датасетах."
        ),
    },
    ...
    # ---- Слайд 11 — Власний внесок ----
    {
        ...
        "result_text": "Реалізація стабільна на ВСІХ типах задач.",
        "speech": (
            "Окремо хочу сказати про власний внесок. При практичній "
            "реалізації розширеного CMA-ES виявився важливий технічний "
            "нюанс. Чисте EM-оновлення коваріаційних матриць, як описано "
            "в оригінальному дослідженні, на простих унімодальних "
            "задачах призводить до колапсу дисперсії. Алгоритм просто "
            "застрягає через п'ять-сім ітерацій. Це не описано у "
            "первинному джерелі. Я запропонував поправку — параметр "
            "cov_lr, момент-усереднення коваріацій між ітераціями. "
            "Аналогічно rank-μ оновленню класичного CMA-ES. Після "
            "поправки алгоритм стабільно сходиться на всіх типах задач."
        ),
    },
    ...
    # ---- Слайд 12 — Заклик + QR ----
    {
        ...
        "github_label": "Повний код проекту:",
        ...
        "speech": (
            ...
            "Виявлено технічну проблему оригінального алгоритму і "
            "запропоновано фікс. Повна реалізація — у відкритому "
            "репозиторії на GitHub. QR-код на слайді веде безпосередньо "
            "до проекту. Дякую за увагу, готовий відповісти на ваші "
            "запитання."
        ),
    },
]
